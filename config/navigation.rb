...
SimpleNavigation::Configuration.run do |navigation|  
  ...
  navigation.items do |menu_level_1|
    ...
    #      inventory.children.displayed.no_item.each do |sub_category|
    #        if sub_category.children.displayed.no_item.empty?
    ...
    #            sub_category.children.displayed.no_item.each do |sub_sub_category|
